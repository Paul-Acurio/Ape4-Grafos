    ...
    static class Grafo {
        ...
        public List<String> dijkstra(String inicio, String fin) {
            ...
            while (!cola.isEmpty()) {
                ...
                // Si la distancia al nodo actual es infinito, se rompe (nodos inalcanzables)
                if (distancias.get(actual) == Integer.MAX_VALUE) break;
                ...
                for (Arista arista : adyacencia.get(actual)) {
                    ...
                    if (nuevaDistancia < distancias.get(arista.destino)) {
                        ...
                        // Removemos y agregamos para que la PriorityQueue se reordene correctamente
            ...
            if (!anteriores.containsKey(fin) && !fin.equals(inicio)) {
                return null;
            }
